...
function get_tour_articles()
{
    $db = db_connect();
    $sql = "SELECT title, content, comments, likes, cover_path FROM article WHERE tag='tour' ORDER BY ardate DESC";
...
list($titles, $contents, $comments, $likes, $cover_photos)=get_tour_articles();
